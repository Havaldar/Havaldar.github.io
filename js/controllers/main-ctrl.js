angular
	.module('Terminal')
	.controller('MainCtrl', ['$scope', '$sce', 'terminalService', function($scope, $sce, terminalService) {
	...
	$scope.enter_command = function(command) {
		terminalService.executeTerminalCommand($scope.guest, $scope.commands, $scope.current_command, $scope.command, $scope.current_dir, $scope.path, $scope.files)
